...
@section('page-body')
    ...
    <form id="regForm" action="{{ route('client.store') }}" class="form-group" method="POST">
        ...
        <div class="tab"> Profile
                ...
                <input placeholder="User Name" name="username"  type="text" class="form-control required"><br>
           
            
                <input placeholder="Password" name="password" type="password" class="form-control required" data-confirmed="re-password"><br>
            
          
                <input placeholder="Retype Password"  name="re-password" type="password" class="form-control required"><br>
