                        ...
                        <table>
                            <tr id="container-t">
                                @foreach($therapists as $data)
                                            ...
                                            <center>
                                                ...
                                                <img src='{{ asset("storage/{$data->image}") }}' style="width:50px;height:50px;">
                                                    ...
                                                    <a class="btn btn-sm btn-info" data-toggle="modal"
                                                       data-target="#view-modal-{{ $data->id }}">View</a>
                                                </div>
                                            </center>
                                        </div>
                                    </td>
                                    ...
                                    <!-- View Modal client-->
                                    <div class="modal fade" id="view-modal-{{ $data->id }}" tabindex="-1" role="dialog"
